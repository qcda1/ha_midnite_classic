...
PARAMETER_META: dict[str, tuple] = {
    ...
    "BatVoltage":             ("Battery Voltage",          "V",   "voltage",     "measurement",        "mdi:battery", 1),
    "PVVoltage":              ("PV Voltage",               "V",   "voltage",     "measurement",        "mdi:solar-panel", 1),
    "BatCurrent":             ("Battery Current",          "A",   "current",     "measurement",        "mdi:current-dc", 1),
    ...
    "PVCurrent":              ("PV Current",               "A",   "current",     "measurement",        "mdi:current-dc", 1),
    "lastVOC":                ("Last VOC",                 "V",   "voltage",     "measurement",        "mdi:solar-panel", 1),
    ...
    "BatTemperature":         ("Battery Temperature",      "°C",  "temperature", "measurement",        "mdi:thermometer", 1),
    "FETTemperature":         ("FET Temperature",          "°C",  "temperature", "measurement",        "mdi:thermometer", 1),
    "PCBTemperature":         ("PCB Temperature",          "°C",  "temperature", "measurement",        "mdi:thermometer", 1),
    ...
    "AbsorbVoltageSetPoint":  ("Absorb Voltage Setpoint",  "V",   "voltage",     "measurement",        "mdi:solar-panel", 1),
    "FloatVoltageSetPoint":   ("Float Voltage Setpoint",   "V",   "voltage",     "measurement",        "mdi:solar-panel", 1),
    "EqualizeVoltageSetPoint": ("Equalize Voltage Setpoint", "V", "voltage",     "measurement",        "mdi:solar-panel", 1),
